...
Данное приложение можно доработать, но главный функционал был реализован. Но так как возможность доработки есть, эта карта проекта будет заполнена.
...
- [x] Проработать детали 
    ...
    - [ ] Реализовать поиск по играм в категориях постов
- [ ] Проработка постов
