...
Изначально существовало смутное представление о *правильной* организации структуры проекта, в особенности бэкенда. Однако просмотрев информацию об этом и закрепив на практике у меня сложилось четкое представление о правилах реализации подобной 
